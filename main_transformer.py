...
if __name__ == '__main__':
    ...
    capture = cv2.VideoCapture('/media/backup_SSD/ASPEDv1_Video/Session_5242023/Cadell/Video/Camera1_GTgopro05/5242023_video1.MP4')
    ...
    while True:
        ...
        if len(bboxes) > 0:
            ...
            list_bboxs = tracker.update(list_bboxs, im)
